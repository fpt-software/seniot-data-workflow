...
(function() {
	...
	! function() {
		function t(t) {
			this.el = t;
			for (var n = t.className.replace(/^\s+|\s+$/g, "").split(/\s+/),
			    i = 0; i < n.length; i++)
				e.call(this, n[i]);
		}
		...
		if (!("undefined" == typeof window.Element || "classList" in document.documentElement)) {
			...
			t, n(Element.prototype, "classList", function() {
				return new t(this);
			});
		}
	}();
	...
	(function() {
		...
		$form.addEventListener('submit', function(event) {
			...
			// Show message.
			$message._show('pending', 'Registering your device with Azure IoT hub!');
			...
			window.setTimeout(function() {
				...
				// Show message.
				$message._show('success', 'Your device has been registered successfully!', true);
